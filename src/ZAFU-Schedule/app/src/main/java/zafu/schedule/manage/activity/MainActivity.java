...
import zafu.schedule.manage.dao.DataBaseHelper;
import zafu.schedule.manage.util.HttpInfoUtil;
import zafu.schedule.manage.util.MyImageView;
...
public class MainActivity extends Activity {
          ...
          protected void onCreate(Bundle savedInstanceState) {
                    ...
                    //找到控件
                    zafu.schedule.manage.util.MyImageView select_course = (zafu.schedule.manage.util.MyImageView) findViewById(R.id.select_course);
                    zafu.schedule.manage.util.MyImageView select_score = (zafu.schedule.manage.util.MyImageView) findViewById(R.id.select_score);
                    zafu.schedule.manage.util.MyImageView select_classroom = (zafu.schedule.manage.util.MyImageView) findViewById(R.id.select_classroom);
                    zafu.schedule.manage.util.MyImageView select_about = (zafu.schedule.manage.util.MyImageView) findViewById(R.id.select_about);
                    //设置课程查询按钮的监听
